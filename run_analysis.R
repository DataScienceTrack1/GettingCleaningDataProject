# The Source Data is the UCI HAR Dataset downloaded from https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip
...
setwd('/Users/Laptop/Documents/UCI HAR Dataset/');
...
write.table(finalData, './finalData.txt',row.names=FALSE,sep='\t');
